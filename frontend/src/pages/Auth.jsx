  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isLogin) {
        ...
        let keyId = null;
        if (role !== 'patient') {
          const verifyRes = await fetch('https://novacare-scog.onrender.com/api/auth/verify-passkey', {
            method: 'POST',
        ...
        const completeRes = await fetch('https://novacare-scog.onrender.com/api/auth/complete-signup', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
            email,
